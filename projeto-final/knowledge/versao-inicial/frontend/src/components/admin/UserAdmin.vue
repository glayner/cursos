            ...
            <b-row>
                <b-col md='6' sm='12'>
                    <b-form-group label="Nome: " label-for="user-name">
                        <b-form-input id="user-name" type="text" v-model="user.name" :readonly="mode === 'remove'" required placeholder="informe o Nome do Usuário..."/>
                    </b-form-group>
                </b-col>
                <b-col md='6' sm='12'>
                    <b-form-group label="E-mail: " label-for="user-email">
                        <b-form-input id="user-email" type="text" v-model="user.email" :readonly="mode === 'remove'" required placeholder="informe o E-mail do Usuário..."/>
                    </b-form-group>
                </b-col>
            </b-row>
